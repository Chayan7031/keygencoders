...
export default function About() {
  ...
  return (
    <div className="gap-4 w-full flex flex-col justify-center items-center h-fit py-20 md:py-40" id="about">
      ...
      <div className="text-5xl font-bold font-sans bg-clip-text text-transparent bg-gradient-to-b from-green-500 to-neutral-500 bg-opacity-50">
        About
      </div>
      <div className="text-zinc-400 w-4/5 font-thin text-center sm:text-lg md:text-xl font-sans">
        {content}
      </div>
    </div>
  );
